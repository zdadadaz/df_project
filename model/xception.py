...
def xception_noTop(num_classes=1000, pretrained='imagenet'):    
    model = Xception(num_classes=num_classes)
    # initialize
...
class xception_lstm(nn.Module):
    def __init__(self, lstm_size, lstm_layer, pretrained = 'imagenet'):
        super(xception_lstm, self).__init__()
        self.cnn = xception_noTop(num_classes=1000, pretrained=pretrained)
